    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-zinc-950 overflow-hidden">
      ...
      <main className="relative z-10 flex flex-col items-center text-center px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Button asChild size="lg" className="bg-violet-600 hover:bg-violet-700 text-white rounded-lg px-8 shadow-md shadow-zinc-950">
            <Link href="/sign-up">Get Started</Link>
          </Button>
          <Button asChild variant="outline" size="lg" className="border-zinc-800 bg-zinc-900 text-zinc-50 hover:bg-zinc-800 rounded-lg px-8">
